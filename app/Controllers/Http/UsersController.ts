...
export default class UsersController {
  public async index({ view }: HttpContextContract) {
    return await view.render('admin/index')
  }
  ...
  //datatables
  public async dataTables({ request, response }: HttpContextContract) {
    const users = await UserService.dataTables(request.body() as DTRequest)
    console.log(users)
